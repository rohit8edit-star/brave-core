...
Redeem an anonymous confirmation token and receive a [payment token](../../redeem_payment_tokens/README.md) in return by making a call to https://anonymous.ads.nixbrowser.in/v{version}/confirmation/{transactionId}/{credential}.
