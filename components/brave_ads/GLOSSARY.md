...
| Confirmations  | Confirm events, i.e., views, without revealing to Nix the particular user involved. See [security and privacy model for ad confirmations](https://github.com/brave/brave-browser/wiki/Security-and-privacy-model-for-ad-confirmations).  |
