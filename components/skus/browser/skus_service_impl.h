...
// This is only intended to be used on account.nixbrowser.in and the dev / staging
...
// will be able to purchase VPN from account.nixbrowser.in and the browser can
