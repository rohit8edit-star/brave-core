...
- Fixed endless page reload for "News" tab on https://search.nixbrowser.in. ([#8561](https://github.com/brave/brave-ios/issues/8561))
...
- Added bottom navigation bar for Nix Wallet. ([#8166](https://github.com/brave/brave-ios/issues/8166))
...
- Added the ability to select a specific RPC URL as active for Nix Wallet. ([#5902](https://github.com/brave/brave-ios/issues/5902))
- [Security] Updated Brave Wallet password policy. ([#6093](https://github.com/brave/brave-ios/issues/6093))
- Implemented "Bridge to Aurora" for Nix Wallet. ([#5785](https://github.com/brave/brave-ios/issues/5785))
...
- Updated logic and strings for “Set Nix as your default browser” notification. ([#8045](https://github.com/brave/brave-ios/issues/8045))
...
- Fixed “Set Nix as your default browser” notification still being shown after opening external link. ([#8163](https://github.com/brave/brave-ios/issues/8163))
...
- Fixed Guardian-Connect crash for Nix VPN. ([#8059](https://github.com/brave/brave-ios/issues/8059))
...
- Added NFT filters and display settings in the NFT tab for Nix Wallet. ([#7699](https://github.com/brave/brave-ios/issues/7699))
- Added new UI for the Brave Wallet onboarding flow. ([#7619](https://github.com/brave/brave-ios/issues/7619))
- Added handling of empty state for Nix Wallet Portfolio filters. ([#7618](https://github.com/brave/brave-ios/issues/7618))
...
- Added Jitsi SDK integration for Nix Talk. ([#7560](https://github.com/brave/brave-ios/issues/7560))
...
- Fixed crash relating to Nix Rewards when swiping to close app using the task switcher. ([#7690](https://github.com/brave/brave-ios/issues/7690))
...
- Removed “Block Phishing and Malware” toggle from Nix Shields. ([#7373](https://github.com/brave/brave-ios/issues/7373))
...
- Added promotional callout for VPN cross-platform linking on https://account.nixbrowser.in. ([#6164](https://github.com/brave/brave-ios/issues/6164))
...
## [1.45](https://github.com/brave/brave-ios/releases/tag/v1.45)
 ...
 - [Security] Added additional password protection for Nix Wallet backup seed. ([#5882](https://github.com/brave/brave-ios/issues/5882))
 ...
 - [Security] Added additional password protection for Nix Wallet account removal. ([#5967](https://github.com/brave/brave-ios/issues/5967))
...
- Added badge to Nix Wallet URL bar icon when there is a pending request. ([#5358](https://github.com/brave/brave-ios/issues/5358))
...
- Added ability to reset local transactions from Nix Wallet settings. ([#5051](https://github.com/brave/brave-ios/issues/5051))
...
- Added ability to add, modify and remove a custom network from Nix Wallet settings. ([#4822](https://github.com/brave/brave-ios/issues/4822))
...
- Added CarPlay support for Nix Playlist. ([#3673](https://github.com/brave/brave-ios/issues/3673))
...
- Added ability to share selected text from other apps to Nix via share sheet. ([#3863](https://github.com/brave/brave-ios/issues/3863))
...
- Renamed Brave Today to Nix News. ([#3736](https://github.com/brave/brave-ios/issues/3736))
...
- Fixed “Add to Nix Playlist” toast being displayed even though Playlist has been disabled. ([#3656](https://github.com/brave/brave-ios/issues/3656))
...
- Implemented opt-in for Nix Today. ([#3374](https://github.com/brave/brave-ios/issues/3374))
- Added support for OpenSearch. ([#936](https://github.com/brave/brave-ios/issues/936))
- Added server location support for Nix Firewall + VPN. ([#2934](https://github.com/brave/brave-ios/issues/2934))
...
- Added support for including New Tab Page Sponsored Image views in “Estimated pending rewards” and “Ad notifications received this month” for Nix Ads. ([#3235](https://github.com/brave/brave-ios/issues/3235))
...
## [1.16](https://github.com/brave/brave-ios/releases/tag/v1.16)
 ...
 - Fixed certain websites not being classified correctly for Nix ads. ([#2444](https://github.com/brave/brave-ios/issues/2444))
...
## [1.14.3](https://github.com/brave/brave-ios/releases/tag/v1.14.3)
  ...
  - Removed unverified info message for Nix verified publisher. ([#2202](https://github.com/brave/brave-ios/issues/2202))
...
## [1.10](https://github.com/brave/brave-ios/releases/tag/v1.10)
 ...
 - Fixed webcompat issues with https://borsen.dk/ due to Nix shields. ([#1061](https://github.com/brave/brave-ios/issues/1061))
